...
import { getProductApi } from '../../service/productApi';
      ...
      <div className="container-fluid px-0 overflow-hidden">
        <header className="position-relative w-100 vh-100 d-flex align-items-center justify-content-center overflow-hidden">
          ...
          <div className="container position-relative text-center text-white z-2">
            <h2 className="display-5 fw-light mb-2 opacity-75">
              這裡，是幸福毛孩故事的起點。
            </h2>
            <h1
            ...
            <button
              onClick={(e) => changeToProducts(e)}
              type="button"
              className="btn btn-light rounded-0 px-5 py-3 fw-bold"
            >
              探索萌寵
            </button>
          </div>
              ...
              {products.map((product) => {
                return (
                  <div className="col" key={product.id}>
                    <div
                      className="card h-100 border-0 product-card text-start"
                      onClick={(e) => changeToSingleProduct(e, product)}
                      ...
                      <div className="card-body p-0">
                        ...
                        >
                          <img
                            ...
                            className="card-img-top rounded-0 object-fit-cover h-100 w-100 product-img"
                            alt={product.title}
                          />
                        </div>
                        <div
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1631679706909-1844bbd07221?q=80&w=1584&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
            height: '600px',
