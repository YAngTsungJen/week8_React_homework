...
import {
  ...
  createAsyncGetProduct,
  setCurrentCategory,
} from '../../slices/productSlice';

function Products() {
  const carts = useSelector((state) => state.cart.carts);
  const { products, pages, isPageLoading, categories, currentCategory } =
      ...
      <div className="container">
        ...
        >
          <ol className="breadcrumb">
            ...
            <li
              className={`breadcrumb-item ${currentCategory === 'all' ? 'active' : ''}`}
            >
              {currentCategory === 'all' ? (
                '萌寵列表'
              ) : (
                          ...
                          <div className="card-body d-flex flex-column">
                            ...
                            <div className="d-flex gap-2">
                              ...
                              <button
                                ...
                                disabled={isLoading[product.id] === 'details'}
