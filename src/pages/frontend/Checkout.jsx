...
import { postOrder } from '../../service/orderApi';
function Checkout() {
      ...
      <div className="container py-5">
        ...
        <div className="row g-5">
          <div className="col-md-7 text-start">
            <h4 className="border-start border-success border-4 ps-2 mb-4 fw-bold text-success">
              訂購人資訊
            </h4>
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="text-end">
                <Link to="/carts" className="btn btn-dark me-2">
                  返回購物車
                </Link>
                <button
                  type="submit"
          ...
          <div className="col-md-5">
            <div
              className="card border-0 shadow-sm p-4 bg-white sticky-top"
              style={{ top: '100px' }}
            >
              <h4 className="fw-bold text-success mb-4 text-center">
                訂單明細
              </h4>
              {carts.map((cart) => {
                return (
                  <div className="d-flex mb-3 align-items-center" key={cart.id}>
                    ...
                    <div className="flex-grow-1 text-start">
                      ...
                      <div className="text-muted extra-small">
                        {cart.qty}
                        {cart.product.unit}毛小孩
                      </div>
                    </div>
                    <div className="fw-bold">
                      ${thousandsStamp(cart.product.price)}
                    </div>
                  </div>
                );
              })}
