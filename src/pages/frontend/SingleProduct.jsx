...
import { getSingleProductApi } from '../../service/productApi';
          ...
          <div className="col-md-5 text-start">
            <div className="ps-md-4">
              ...
              <div className="d-flex align-items-baseline mb-4">
                <h3 className="text-danger fw-bold me-2">
                  NT$ {thousandsStamp(product.price)}
                </h3>
                <del className="text-muted small">
                  NT$ {thousandsStamp(product.origin_price)}
                </del>
              </div>
              {cartsQty > 0 && (
              ...
              <div className="d-flex align-items-center mb-4">
                <label style={{ width: '120px' }} className="fw-bold">
                  購買數量：
                </label>
              ...
              <div className="d-grid gap-2">
                <button
                  className="btn btn-dark btn-lg rounded-0 py-3 d-flex justify-content-center align-items-center"
                  disabled={isLoading}
                  onClick={(e) => addCart(e, product.id, qty)}
                >
                  {isLoading ? (
                    <ThreeCircles
                      wrapperStyle={{}}
                ...
                <button
                  className="btn btn-outline-secondary btn-lg rounded-0 py-3"
